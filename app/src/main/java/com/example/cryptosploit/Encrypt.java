...
public class Encrypt extends AppCompatActivity {
    ...
    String encryptVigenere(String text, final String key)
    {
        String res = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        algoText = (TextView) findViewById(R.id.textAlgorithm);
        Intent intent = getIntent();
        String encAlgo = intent.getStringExtra("algorithm");
        algoText.setText(encAlgo);

        encAction = findViewById(R.id.encBtn);
        cText =  findViewById(R.id.editCipherText);
        cryptoResult = findViewById(R.id.encResult);
        ...
        encAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(encAlgo.equals("BASE64")) {
                    ...
                    String result = encoder.encodeToString(cipherText.getBytes());
                    cryptoResult.setText(result);
                }
                if(encAlgo.equals("VIGENERE")) {
                    String result = encryptVigenere(cipherText,"android");
                    cryptoResult.setText(result);
                }
